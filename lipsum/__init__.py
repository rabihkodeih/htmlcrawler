...
_DEFAULT_SAMPLE = pkg_resources.resource_string('lipsum', 'data/sample.txt') #@UndefinedVariable

_DEFAULT_DICT = pkg_resources.resource_string('lipsum', 'data/dictionary.txt').split() #@UndefinedVariable
